        ...
        <Box sx={{ display:"flex"}}>
            ...
            >
                ...
                <div class="card w-100 h-100" style={{ backgroundColor: "aqua", color: "black" }}>
                    <div class="card-body">
                        <h1 class="card-title" style={{ fontWeight: "bold" }}>GETTING DATA FROM API</h1>
                        <p class="card-text">
                            <hr></hr>
                        ...
                        <Button onClick={GetApi} sx={{ backgroundColor: "white", width: "300px", height: "50px", color: "#1976d2", fontSize: "1.5rem" }} variant="contained">Get Data</Button>
                    </div>
                </div>
