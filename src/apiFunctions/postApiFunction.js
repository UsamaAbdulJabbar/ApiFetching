...
function PostApiFunction(props) {
        ...
        <Box sx={{ display:"flex"}}>
            ...
            >
                ...
                <div class="card w-100 h-100" style={{ backgroundColor: "aqua", color: "black" }}>
                    <div class="card-body">
                        <h1 class="card-title" style={{ fontWeight: "bold" }}>POST  DATA FROM API</h1>
                        <p class="card-text">
                            <hr></hr>
                        ...
                        <Button onClick={PostApi} sx={{ backgroundColor: "white", width: "300px", height: "50px", color: "#1976d2", fontSize: "1.5rem" }} variant="contained">Post Data</Button>
                    </div>
                </div>
